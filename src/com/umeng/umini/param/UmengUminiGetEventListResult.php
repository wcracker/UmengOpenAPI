...
use Wcracker\UmengOpenAPI\com\umeng\umini\param\UmengUminiEventDTO;

class UmengUminiGetEventListResult
{
    private $data;
    ...
    public function setStdResult($stdResult)
    {
        ...
        if ((new \Wcracker\UmengOpenAPI\Common)->is_array_key_exists("data", $this->stdResult)) {
            ...
            for ($i = 0; $i < count($object); $i ++) {
                ...
                $UmengUminiEventDTOResult=new UmengUminiEventDTO();
                $UmengUminiEventDTOResult->setArrayResult($arrayobject);
                $this->data [$i] = $UmengUminiEventDTOResult;
            }
        }
