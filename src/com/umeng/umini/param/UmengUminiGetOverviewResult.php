...
use Wcracker\UmengOpenAPI\com\umeng\umini\param\UmengUminiOverviewDTO;

class UmengUminiGetOverviewResult
{
    private $data;
    ...
    */
    ...
    /**
     * 设置
     * @param UmengUminiOverviewDTO $data

     * 此参数必填     */
    public function setData(UmengUminiOverviewDTO $data)
    {
        $this->data = $data;
    }
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (is_array_key_exists("data", $this->stdResult)) {
            ...
            $this->data = new UmengUminiOverviewDTO();
