...
use Wcracker\UmengOpenAPI\com\umeng\umini\param\UmengUminiSharePageOverviewDTO;

class UmengUminiGetSharePageOverviewResult
{
    private $data;
    ...
    */
    ...
    /**
     * 设置
     * @param UmengUminiSharePageOverviewDTO $data

     * 此参数必填     */
    public function setData(UmengUminiSharePageOverviewDTO $data)
    {
        $this->data = $data;
    }
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (is_array_key_exists("data", $this->stdResult)) {
            ...
            $this->data = new UmengUminiSharePageOverviewDTO();
