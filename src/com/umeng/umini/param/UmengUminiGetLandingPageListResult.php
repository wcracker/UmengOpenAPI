...
use Wcracker\UmengOpenAPI\com\umeng\umini\param\UmengUminiLandingPageListDTO;

class UmengUminiGetLandingPageListResult
{
    private $data;
    ...
    */
    ...
    /**
     * 设置结果数据
     * @param UmengUminiLandingPageListDTO $data

     * 此参数必填     */
    public function setData(UmengUminiLandingPageListDTO $data)
    {
        $this->data = $data;
    }
