...
class Apptrack extends AbstractApplication
{
    ...
    protected function getParamObject()
    {
        ...
        $className = "\\Wcracker\\UmengOpenAPI\\com\\umeng\\apptrack\\param\\UmengApptrack{$apiName}Param";
    ...
    {
        $apiName = ucfirst($this->apiName);
        $className = "\\Wcracker\\UmengOpenAPI\\com\\umeng\\apptrack\\param\\UmengApptrack{$apiName}Result";
        return new $className();
    }
