...
class UmengUminiAppIndicatorDTO extends SDKDomain
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if ((new \Wcracker\UmengOpenAPI\Common)->is_array_key_exists("dailyDuration", $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if ((new \Wcracker\UmengOpenAPI\Common)->is_array_key_exists("dailyDuration", $this->arrayResult)) {
