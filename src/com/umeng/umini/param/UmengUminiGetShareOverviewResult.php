...
use Wcracker\UmengOpenAPI\com\umeng\umini\param\UmengUminiShareOverviewDTO;

class UmengUminiGetShareOverviewResult
{
    private $data;
    ...
    */
    ...
    /**
     * 设置
     * @param UmengUminiShareOverviewDTO $data

     * 此参数必填     */
    public function setData(UmengUminiShareOverviewDTO $data)
    {
        $this->data = $data;
    }
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (is_array_key_exists("data", $this->stdResult)) {
            ...
            $this->data = new UmengUminiShareOverviewDTO();
