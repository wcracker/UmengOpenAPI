...
use Wcracker\UmengOpenAPI\com\umeng\umini\param\UmengUminiAppListDTO;
...
class UmengUminiGetAppListResult
{
    ...
    */
    ...
    /**
     * 设置
     * @param UmengUminiAppListDTO $data

     * 此参数必填     */
    public function setData(UmengUminiAppListDTO $data)
    {
        $this->data = $data;
    }
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if (is_array_key_exists("data", $this->stdResult)) {
            ...
            $this->data = new UmengUminiAppListDTO();
