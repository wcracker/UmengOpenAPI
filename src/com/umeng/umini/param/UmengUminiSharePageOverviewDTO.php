...
use Wcracker\UmengOpenAPI\com\umeng\umini\param\UmengUminiSharePageIndicatorDTO;

class UmengUminiSharePageOverviewDTO extends SDKDomain
{
    private $currentPage;
    ...
    */
    ...
    /**
     * 设置
     * @param array include @see UmengUminiSharePageIndicatorDTO[] $data
     * 参数示例：<pre></pre>
     * 此参数必填     */
    public function setData(UmengUminiSharePageIndicatorDTO $data)
    {
        $this->data = $data;
    }
    ...
    public function setStdResult($stdResult)
    {
        ...
        if ((new \Wcracker\UmengOpenAPI\Common)->is_array_key_exists("data", $this->stdResult)) {
            ...
            for ($i = 0; $i < count($object); $i ++) {
                ...
                $UmengUminiSharePageIndicatorDTOResult=new UmengUminiSharePageIndicatorDTO();
                $UmengUminiSharePageIndicatorDTOResult->setArrayResult($arrayobject);
                $this->data [$i] = $UmengUminiSharePageIndicatorDTOResult;
            }
        }
    }
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if ((new \Wcracker\UmengOpenAPI\Common)->is_array_key_exists("data", $this->arrayResult)) {
            ...
            $this->data = new UmengUminiSharePageIndicatorDTO();
