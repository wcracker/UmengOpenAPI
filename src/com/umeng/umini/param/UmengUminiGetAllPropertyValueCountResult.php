...
use Wcracker\UmengOpenAPI\com\umeng\umini\param\UmengUminiAllPropertyValueCountDTO;

class UmengUminiGetAllPropertyValueCountResult
{
    private $data;
    ...
    */
    ...
    /**
     * 设置
     * @param UmengUminiAllPropertyValueCountDTO $data

     * 此参数必填     */
    public function setData(UmengUminiAllPropertyValueCountDTO $data)
    {
        $this->data = $data;
    }
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if ((new \Wcracker\UmengOpenAPI\Common)->is_array_key_exists("data", $this->stdResult)) {
            ...
            $this->data = new UmengUminiAllPropertyValueCountDTO();
