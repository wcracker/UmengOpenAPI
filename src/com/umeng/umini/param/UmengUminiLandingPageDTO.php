...
class UmengUminiLandingPageDTO extends SDKDomain
{
    ...
    */
    ...
    public function setStdResult($stdResult)
    {
        ...
        if ((new \Wcracker\UmengOpenAPI\Common)->is_array_key_exists("jumpRatio", $this->stdResult)) {
    ...
    public function setArrayResult($arrayResult)
    {
        ...
        if ((new \Wcracker\UmengOpenAPI\Common)->is_array_key_exists("jumpRatio", $this->arrayResult)) {
